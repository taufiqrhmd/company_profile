    ...
    <div class="container max-w-7xl mx-auto px-4 md:px-6">
      ...
      <div
        ...
        <div class="lg:col-span-8">
          ...
          <h2
            class="text-4xl sm:text-6xl md:text-8xl font-black text-dark dark:text-soft leading-[0.9] md:leading-[0.85] tracking-tighter uppercase mb-8 md:mb-10">
            A COLLECTIVE OF <br />
          ...
          <div v-for="(stat, i) in stats" :key="i"
            ...
            <div class="relative z-10">
              <div class="flex items-baseline gap-1">
                <h4 class="text-3xl md:text-5xl font-black text-primary leading-none tracking-tighter">{{ stat.value }}
                </h4>
...
const handleJoinTeam = () => {
  handleNav('#contact', true);
};

// Fungsi navigasi yang konsisten
...
const values = [
  { title: "Methodical Design", desc: "Kami mendekati setiap tantangan visual dengan metode yang terukur dan berorientasi hasil." },
  { title: "Technical Rigor", desc: "Arsitektur kode kami dibangun untuk stabilitas, keamanan, dan skalabilitas jangka panjang." },
  { title: "Elite Strategy", desc: "Menganalisis pasar secara mendalam untuk memposisikan brand Anda di atas kompetisi." }
];
